...
export const mdxComponents: MDXComponentsType = {
  ...
  thead: ({ children, ...props }) => (
    <thead className="border-b border-accent-cyan/20" {...props}>
      {children}
    </thead>
  ),
  th: ({ children, ...props }) => (
    <th
      className="px-4 py-2 text-left font-heading text-[11px] uppercase tracking-[0.15em] text-accent-cyan"
      {...props}
    >
      {children}
    </th>
  ...
  td: ({ children, ...props }) => (
    <td
      className="border-b border-white/5 px-4 py-2 text-text-secondary"
      {...props}
    >
      {children}
    </td>
